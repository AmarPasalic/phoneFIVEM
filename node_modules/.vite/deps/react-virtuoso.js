...
// node_modules/.pnpm/react-virtuoso@4.13.0_react-dom@17.0.2_react@17.0.2__react@17.0.2/node_modules/react-virtuoso/dist/index.mjs
...
var xo = () => typeof globalThis > "u" ? window : globalThis;
var Vt = U(
  () => {
    const t = C(
      3
...
function _e(t, e, n) {
  const o = import_react.default.useRef(null), r = import_react.default.useCallback(
    ...
    [t, e]
  ), { callbackRef: s, ref: i } = Ge(r, true, n), l = import_react.default.useCallback(() => {
    r(i.current);
  }, [r, i]);
...
function Le(t, e) {
  ...
  if (e === n) {
    ...
    return e < n ? ge(ot(t, { l: Le(o, e) })) : ge(ot(t, { r: Le(r, e) }));
}
function Gt(t) {
...
var zo = typeof document < "u" && "scrollBehavior" in document.documentElement.style;
function Dn(t) {
...
var _o = (t, e) => typeof t == "function" ? xn(t(e)) : e && xn(t);
var No = U(
  ([
...
var je = U(([{ scrollContainerState: t, scrollTo: e }]) => {
...
var Zo = qn(() => /iP(ad|od|hone)/i.test(navigator.userAgent) && /WebKit/i.test(navigator.userAgent));
var Xo = U(
  ([
...
function qe(t, e, n) {
  ...
  const S = import_react.default.forwardRef((d, u) => {
    const { children: T, ...R } = d, [I] = import_react.default.useState(() => ve(Io(t), (k) => {
      c(k, R);
    })), [f] = import_react.default.useState(un(p, I));
    pe(() => {
      for (const k of i)
        k in R && K(f[k], R[k]);
      return () => {
      ...
      c(I, R);
    }), import_react.default.useImperativeHandle(u, cn(a(I)));
    const b = n;
    return (0, import_jsx_runtime.jsx)(l.Provider, { value: I, children: n ? (0, import_jsx_runtime.jsx)(b, { ...Qo([...o, ...r, ...i], R), children: T }) : T });
  }), g = (d) => {
    ...
    const T = import_react.default.useContext(l)[d], R = import_react.default.useCallback(
      (I) => K(T, I),
      [T]
    );
    ...
    const T = import_react.default.useContext(l)[d], [R, I] = import_react.default.useState(un(st, T));
    return pe(
      () => K(T, (f) => {
        f !== R && I(cn(f));
      }),
  ...
  }, v = import_react.default.version.startsWith("18") ? h : w;
  return {
    Component: S,
    useEmitter: (d, u) => {
      const R = import_react.default.useContext(l)[d];
      pe(() => K(R, u), [u, R]);
    },
    useEmitterValue: v,
    usePublisher: g
...
var Zn = import_react.default.createContext(void 0);
var Xn = typeof document < "u" ? import_react.default.useLayoutEffect : import_react.default.useEffect;
function ke(t) {
  return "self" in t;
}
function tr(t) {
...
function Jn(t, e, n, o = Yt, r, s) {
  const i = import_react.default.useRef(null), l = import_react.default.useRef(null), c = import_react.default.useRef(null), a = import_react.default.useCallback(
    (g) => {
      ...
      g.suppressFlushSync ? d() : import_react_dom.default.flushSync(d), l.current !== null && (v === l.current || v <= 0 || v === h - w) && (l.current = null, e(true), c.current && (clearTimeout(c.current), c.current = null));
    },
    [t, e, s]
  );
...
var or = ({ height: t }) => (0, import_jsx_runtime.jsx)("div", { style: { height: t } });
var rr = { overflowAnchor: "none", position: Ye(), zIndex: 1 };
var Qn = { overflowAnchor: "none" };
var sr = { ...Qn, display: "inline-block", height: "100%" };
var Cn = import_react.default.memo(function({ showTopList: e = false }) {
  ...
  return !e && n.totalCount === 0 && R ? (0, import_jsx_runtime.jsx)(R, { ...q(R, p) }) : (0, import_jsx_runtime.jsx)(
    f,
    {
      ...q(f, p),
...
function Xe({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, ...l }) {
    ...
    return t("scrollTo", m), t("scrollBy", w), (0, import_jsx_runtime.jsx)(
      a,
      {
...
function Je({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, ...l }) {
    const c = n("windowScrollContainerState"), a = e("ScrollerComponent"), p = n("smoothScrollTargetReached"), S = e("totalListHeight"), g = e("deviation"), h = e("customScrollParent"), w = e("context"), v = import_react.default.useRef(null), m = e("scrollerRef"), { scrollByCallback: d, scrollerRef: u, scrollToCallback: T } = Jn(
      c,
      p,
      a,
      m,
    ...
    }, [u, h]), t("windowScrollTo", T), t("scrollBy", d), (0, import_jsx_runtime.jsx)(
      a,
      {
        ref: v,
        "data-virtuoso-scroller": true,
...
var fr = ({ children: t }) => {
  const e = import_react.default.useContext(be), n = gt("windowViewportRect"), o = gt("fixedItemHeight"), r = M("customScrollParent"), s = _e(
    n,
    r,
    M("skipAnimationFrameInResizeObserver")
  ), i = M("alignToBottom");
...
var pr = import_react.default.memo(function(e) {
  ...
  return (0, import_jsx_runtime.jsxs)(i, { ...e, ...q(i, s), children: [
    o && (0, import_jsx_runtime.jsx)(mr, { children: (0, import_jsx_runtime.jsx)(Cn, { showTopList: true }) }),
...
var hr = Xe({ useEmitter: Qe, useEmitterValue: M, usePublisher: gt });
var gr = Je({ useEmitter: Qe, useEmitterValue: M, usePublisher: gt });
var jr = eo;
var qr = eo;
var Ir = U(() => {
...
var xr = ({ height: t }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height: t } }) });
var Tr = ({ height: t }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { border: 0, height: t, padding: 0 } }) });
var Cr = { overflowAnchor: "none" };
var wn = { position: Ye(), zIndex: 2, overflowAnchor: "none" };
var vn = import_react.default.memo(function({ showTopList: e = false }) {
  const n = W("listState"), o = W("computeItemKey"), r = W("firstItemIndex"), s = W("context"), i = W("isSeeking"), l = W("fixedHeaderHeight"), c = W("groupIndices").length > 0, a = W("itemContent"), p = W("groupContent"), S = W("ScrollSeekPlaceholder") || xr, g = W("GroupComponent"), h = W("TableRowComponent"), w = (e ? n.topItems : []).reduce((m, d, u) => (u === 0 ? m.push(d.size) : m.push(m[u - 1] + d.size), m), []), v = (e ? n.topItems : n.items).map((m) => {
    ...
    ) : m.type === "group" ? (0, import_react.createElement)(
      g,
      {
        ...q(g, s),
        "data-index": d,
...
var wr = import_react.default.memo(function() {
  ...
  if (R === 0 && m)
    return (0, import_jsx_runtime.jsx)(m, { ...q(m, I) });
  const f = (n ? e.topItems : []).reduce((V, D) => V + D.size, 0), b = e.offsetTop + T + w - f, k = e.offsetBottom, F = b > 0 ? (0, import_jsx_runtime.jsx)(d, { context: I, height: b }, "padding-top") : null, L = k > 0 ? (0, import_jsx_runtime.jsx)(d, { context: I, height: k }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(u, { "data-testid": "virtuoso-item-list", ref: g, ...q(u, I), children: [
    F,
...
var vr = ({ children: t }) => {
  const e = import_react.default.useContext(be), n = Tt("viewportHeight"), o = Tt("fixedItemHeight"), r = Ht(
    import_react.default.useMemo(() => ne(n, (s) => wt(s, "height")), [n]),
    true,
    W("skipAnimationFrameInResizeObserver")
  );
  return import_react.default.useEffect(() => {
...
var yr = ({ children: t }) => {
  const e = import_react.default.useContext(be), n = Tt("windowViewportRect"), o = Tt("fixedItemHeight"), r = W("customScrollParent"), s = _e(
    n,
    r,
    W("skipAnimationFrameInResizeObserver")
  );
...
var Rr = import_react.default.memo(function(e) {
  const n = W("useWindowScroll"), o = W("customScrollParent"), r = Tt("fixedHeaderHeight"), s = Tt("fixedFooterHeight"), i = W("fixedHeaderContent"), l = W("fixedFooterContent"), c = W("context"), a = Ht(
    import_react.default.useMemo(() => ne(r, (u) => wt(u, "height")), [r]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), p = Ht(
    import_react.default.useMemo(() => ne(s, (u) => wt(u, "height")), [s]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), S = o || n ? Hr : br, g = o || n ? yr : vr, h = W("TableComponent"), w = W("TableHeadComponent"), v = W("TableFooterComponent"), m = i ? (0, import_jsx_runtime.jsx)(
    w,
    {
      ref: a,
    ...
    "TableHead"
  ) : null, d = l ? (0, import_jsx_runtime.jsx)(
    v,
    {
      ref: p,
  ...
  return (0, import_jsx_runtime.jsx)(S, { ...e, ...q(S, c), children: (0, import_jsx_runtime.jsx)(g, { children: (0, import_jsx_runtime.jsxs)(h, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...q(h, c), children: [
    m,
...
var br = Xe({ useEmitter: tn, useEmitterValue: W, usePublisher: Tt });
var Hr = Je({ useEmitter: tn, useEmitterValue: W, usePublisher: Tt });
var Yr = no;
var Zr = no;
var yn = {
  bottom: 0,
...
var Ar = ({ children: t }) => {
  const e = import_react.default.useContext(Zn), n = It("itemDimensions"), o = It("viewportDimensions"), r = Ht(
    import_react.default.useMemo(
      () => (s) => {
...
var Mr = ({ children: t }) => {
  const e = import_react.default.useContext(Zn), n = It("windowViewportRect"), o = It("itemDimensions"), r = et("customScrollParent"), s = _e(n, r, false);
  return import_react.default.useEffect(() => {
...
var _r = Xe({ useEmitter: ro, useEmitterValue: et, usePublisher: It });
var Nr = Je({ useEmitter: ro, useEmitterValue: et, usePublisher: It });
function Bn(t, e, n) {
  return e !== "normal" && !(e != null && e.endsWith("px")) && n(`${t} was not resolved to pixel value correctly`, e, mt.WARN), e === "normal" ? 0 : parseInt(e != null ? e : "0", 10);
}
var Xr = Gr;
