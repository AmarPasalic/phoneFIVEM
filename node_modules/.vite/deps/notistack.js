...
// node_modules/.pnpm/notistack@3.0.0-alpha.7_csstype@3.1.3_react-dom@17.0.2_react@17.0.2__react@17.0.2/node_modules/notistack/notistack.esm.js
...
var Transition = function(_React$Component) {
  ...
  _proto.performEnter = function performEnter(mounting) {
    var _this2 = this;
    var _this$props = this.props, enter = _this$props.enter, id = _this$props.id;
  ...
  _proto.performExit = function performExit() {
    var _this3 = this;
    var _this$props2 = this.props, exit = _this$props2.exit, id = _this$props2.id;
    var timeouts = this.getTimeouts();
    if (!exit) {
      this.safeSetState({
        status: EXITED
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props, children = _this$props3.children, childProps = _objectWithoutPropertiesLoose(_this$props3, ["children", "id", "in", "mountOnEnter", "unmountOnExit", "appear", "enter", "exit", "timeout", "addEndListener", "onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "nodeRef"]);
...
var Slide = (0, import_react.forwardRef)(function(props, ref) {
  ...
  var handleEnter = function handleEnter2(node, isAppearing, snackId) {
  ...
  var handleExit = function handleExit2(node, snackId) {
  ...
  var handleExited = function handleExited2(node, snackId) {
...
var Collapse = (0, import_react.forwardRef)(function(props, ref) {
  var children = props.children, inProp = props["in"], onExited = props.onExited, id = props.id;
...
var MaterialDesignContent = (0, import_react.forwardRef)(function(props, forwardedRef) {
  var id = props.id, message = props.message, componentOrFunctionAction = props.action, iconVariant = props.iconVariant, variant = props.variant, hideIconVariant = props.hideIconVariant, style = props.style;
  ...
  return import_react.default.createElement(SnackbarContent, {
    ...
    role: "alert",
    style,
    className: clsx_m_default(ComponentClasses.MuiContent, classes$2.root, classes$2[variant], !hideIconVariant && icon && classes$2.lessPadding)
